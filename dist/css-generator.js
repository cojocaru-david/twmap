...
class CSSGenerator {
    async generateCSS(mappings, outputPath, compress = false) {
        ...
        if (compress) {
            ...
            const cssnano = await Promise.resolve().then(() => __importStar(require('cssnano')));
            const result = await postcss.default([cssnano.default]).process(cssContent, { from: undefined });
